    ...
    <div className="flex flex-col h-screen bg-dhikr-deep text-dhikr-sand select-none touch-none">
      ...
      <header className="flex justify-between items-center p-6 pt-12">
        ...
        <div className="flex flex-col items-center">
          <span className="text-xs uppercase tracking-widest opacity-50">Target</span>
      ...
      >
        ...
        <div className="mt-8 text-sm uppercase tracking-[0.3em] opacity-30">
      ...
      <footer className="p-12 flex justify-center">
        <button
          ...
          className="flex items-center gap-2 px-6 py-3 rounded-full bg-white/5 border border-white/10 active:bg-white/20 transition-all font-medium"
        >
          <RotateCcw size={18} />
          Reset
        </button>
        ...
        {showResetConfirm && (
          ...
          >
            ...
            >
              ...
              <p className="text-dhikr-sand/60 mb-8">This will end your current session and save it to history.</p>
              <div className="flex gap-4">
                <button
                  onClick={() => setShowResetConfirm(false)}
                  className="flex-1 py-4 rounded-2xl bg-white/5 border border-white/10 font-medium"
                >
                  Cancel
                </button>
                <button
                  onClick={resetCount}
                  className="flex-1 py-4 rounded-2xl bg-red-500/20 border border-red-500/50 text-red-400 font-medium"
                >
                  Reset
                </button>
              </div>
        ...
        {showSettings && (
          ...
          >
            ...
            <div className="flex-1 p-6 space-y-12">
              <section>
                <h3 className="text-xs uppercase tracking-widest opacity-50 mb-6">Select Target</h3>
        ...
        {showHistory && (
          ...
          >
            <header className="flex items-center p-6 pt-12">
              ...
              <h2 className="text-xl font-semibold ml-4">History</h2>
            </header>
            ...
            <div className="flex-1 overflow-y-auto p-6 space-y-4">
              {history.length === 0 ? (
                <div className="flex flex-col items-center justify-center h-full opacity-30 text-center">
                  ...
                  <p>No history yet.<br />Sessions are saved when you reset.</p>
                </div>
              ) : (
                history.map(item => (
                  <div key={item.id} className="p-5 rounded-3xl bg-white/5 border border-white/10 flex justify-between items-center">
                    <div>
